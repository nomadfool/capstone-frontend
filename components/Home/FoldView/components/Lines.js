...
export const ThickGrayLine = (props) => <ThickLine color={'#BDC2C9'} {...props} />;

export const ThickWhiteLine = (props) => <ThickLine color={'#FFFFFF'} {...props} />;

export const ThickDarkGrayLine = (props) => <ThickLine color={'#33373B'} {...props} />;
